...
class DruidCommand extends commando.Command
{
    ...
    async run(message , args)
    {
        var myinfo = new discord.RichEmbed()
            ...
            .addField("**Баланс**", "[дд](https://www.icy-veins.com/wow/balance-druid-pve-dps-guide)", true) 
            .addField("**Кот**", "[дд](https://www.icy-veins.com/wow/feral-druid-pve-dps-guide)", true) 
            .addField("**Дерево**", "[хил](https://www.icy-veins.com/wow/restoration-druid-pve-healing-guide)", true)
