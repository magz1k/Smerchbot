...
class DruidCommand extends commando.Command
{
    ...
    async run(message , args)
    {
        var myinfo = new discord.RichEmbed()
            ...
            .addField("<:dd:567647267578707988>**Баланс**", "[дд](https://www.icy-veins.com/wow/balance-druid-pve-dps-guide)", true) 
            .addField("<:dd:567647267578707988>**Кот**", "[дд](https://www.icy-veins.com/wow/feral-druid-pve-dps-guide)", true) 
            .addField("<:heal:567647266962276352>**Дерево**", "[хил](https://www.icy-veins.com/wow/restoration-druid-pve-healing-guide)", true)
