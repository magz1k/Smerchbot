...
class InfoCommand extends commando.Command
{
    ...
    async run(message , args)
    {
        var myinfo = new discord.RichEmbed()
            ...
            .addField("Требования", "• itmlvl 390+ • Возможность посещения более 95% рейдов • Быть подготовленным к боссу - ознакомится в атласе, прочитать тактику, посмотреть видео гайды. • Адекватное понимание рейдовой политики и решений руководства гильдии (у нас практикуются ротации и замены), • Согласие с #правила-гильдии", true)
