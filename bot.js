...
bot.on('voiceStateUpdate', (oldMember, newMember) => {
    ...
    let oldChannel = oldMember.voiceChannel ? oldMember.voiceChannel.name('518000470795747329') : null;
    let newChannel = newMember.voiceChannel ? newMember.voiceChannel.name('518000470795747329') : null;
