...
bot.on('voiceStateUpdate', (oldMember, newMember) => {
    ...
    let oldChannel = oldMember.voiceChannel ? oldMember.voiceChannelID.name('518000470795747329') : null;
    let newChannel = newMember.voiceChannel ? newMember.voiceChannelID.name : null;
